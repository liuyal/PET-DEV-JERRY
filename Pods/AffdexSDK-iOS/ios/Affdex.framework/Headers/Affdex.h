...
#undef SDK_VERSION
#undef iOS_SDK_VERSION
#undef macOS_SDK_VERSION
#define iOS_SDK_VERSION "4.0"
#define macOS_SDK_VERSION "3.2.0"
...
/**
 ...
 <br>
 <ul>
 <li>iOS: Any iPad, iPhone, or iPod Touch running iOS 9 or newer.</li>
